...
class GUI : public IC4_k20 {
    ...
    FlexButton home_page_btn, pos_ctrl_page_btn;        // Button to toggle home page

  public:
  
    Position_Control_Page position_control_page;        // Define Position_Control_Page
    int32_t target_force = 0, target_position = 0;      // Define a target position variable. Initialize to 0, this will be used to set the motor force or position from the .ino loop
    ...
    {
      set_server_name("Tutorial 5");                    // Server name, changes the name in the initial connection message with IrisControls
    ...
    */
    void run() {
      check();                                          // Parses incomming serial communications (IrisControls -> Eagle)
    ...
    private:
        ...
        */
        void setup() {
          ...
          print_l("Home Page: Sleep mode with motor plot panel and slider to plot additional data\r Position Page: Position mode configurable signal following\r"); // Message is printed when IrisControls establishes a connection with the Eagle
        ...
        */
        ...
        int parse_app(char * cmd, char * args) {
            ...
            */
            ...
            print_l("\rworld");                               // Print "world" to console
            ...
            // Command message "error" prints list of active error codes
