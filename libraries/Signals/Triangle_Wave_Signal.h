...
class TriangleWave : public Signal_Parameters {
    ...
    public:
        ...
        */
        void init(int32_t init_value, uint32_t max_target, uint32_t min_target, uint32_t time_period){
            ...
            period = 500 * time_period; // Multiply by 1000/2 to get the # of microseconds between the maximum and minimum
        ...
        */
        uint32_t run(){
            ...
            unsigned long long elapsed_time = micros() - start_time;
