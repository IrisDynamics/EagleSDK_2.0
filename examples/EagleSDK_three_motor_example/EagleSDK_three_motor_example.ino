/**
 * @file EagleSDK_three_motor_example.ino
 * @author Rebecca McWilliam <rmcwilliam@irisdynamics.com>
 * @brief Example of using three actuator objects to create motor movement with either position control or force control
...
/*
    Interrupts handling for uart 0, 1, and 2
